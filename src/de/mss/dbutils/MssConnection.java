...
public class MssConnection {
   ...
   public MssResultSet executeQuery(String loggingId, String query) throws MssException {
      connect();
      return getConnectionFromPool(loggingId).executeQuery(loggingId, query);
   }


   public MssResultSet executeQuery(String loggingId, PreparedStatement prepStmt) throws MssException {
      connect();
